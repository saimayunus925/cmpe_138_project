...
--
-- Host: localhost
-- Generation Time: Nov 19, 2020 at 11:09 PM
...
(1833, 'LifeFitness T5', 'Treadmill', 1120, 28, '1/6/20', 0),
...
INSERT INTO `member` (`mem_id`, `attendance`, `user_cost`, `mem_lvl`, `level_num`, `mem_lname`, `mem_fname`, `mem_dob`, `mem_status`) VALUES
(3212, 30, 69, 'Bronze', '1', 'Nguyen', 'Emily', '1/31/72', 1),
(3534, 3, 63.9, 'Gold', '2', 'Millar', 'Steven', '12/29/83', 0),
(3655, 28, 66.4, 'Bronze', '1', 'Savid', 'Michael', '2/6/85', 1),
(4208, 75, 187.5, 'Platinum', '3', 'Nguyen', 'Kevin', '9/16/01', 0),
(4223, 25, 62.5, 'Bronze', '1', 'Vance', 'Jordan', '7/8/82', 0),
(5463, 25, 92.5, 'Gold', '2', 'Lang', 'Suzy', '8/9/95', 1),
(5484, 80, 164, 'Gold', '2', 'Johnson', 'Xavier', '3/25/86	', 1),
(7766, 44, 87.2, 'Bronze', '1', 'Hutchinson', 'Jim', '6/5/96', 0),
(8457, 27, 95.1, 'Gold', '2', 'Durham', 'Alison', '2/28/97', 0),
(8643, 37, 138.1, 'Platinum', '3', 'Benson', 'Mark', '9/25/87', 0),
(9987, 37, 108.1, 'Gold', '2', 'Chung', 'Vince', '4/11/01', 1);
...
--
ALTER TABLE `employee`
  MODIFY `e_id` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7441;
COMMIT;
